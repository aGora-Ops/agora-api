"""Amazon Titan text-embeddings helper for the RAG pipeline.

Uses titan-embed-text-v2 (1024-dim, normalized for cosine similarity) via the
same cross-account Bedrock path as the chat/remediation models.
"""
import json
